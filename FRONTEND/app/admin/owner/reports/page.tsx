...
import { useOwnerReports } from "@/hooks/owner/use-owner-reports"
...
export default function OwnerReportsPage() {
  const { invoices, metrics, riskMetrics, isLoading } = useOwnerReports()
    ...
    <div className="space-y-6 w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3">
        ...
        <ReportDownloadMenu
          ...
          filename={`owner-report-${periodLabel.toLowerCase().replace(/ /g, "-")}`}
        />
      </div>
