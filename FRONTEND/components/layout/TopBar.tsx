            ...
            <div className="flex items-center gap-2 sm:gap-4 shrink-0">
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="ghost" className="group pl-1.5 pr-1.5 sm:pr-4 py-1.5 sm:py-2 h-auto flex items-center gap-1.5 sm:gap-3 hover:bg-muted/50 rounded-full border border-border data-[state=open]:bg-muted/50 shrink-0" suppressHydrationWarning>
